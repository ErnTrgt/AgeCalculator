...
export const dict = {
  tr: {
    ...
    cover: {
      ...
      subtitle: "Doğum tarihini gir. Gerisini sayılara bırakalım.",
      day: "Gün",
      month: "Ay",
      year: "Yıl",
      calculate: "Hayatımı paketle",
      hint: "Tek bir tarih. Sonrası sürpriz.",
    },
    ...
    s_cosmic_caption: "Kocaman bir kaya parçasının üstünde, durmadan dönüyorsun.",
    ...
    s_weeks_note: "Izgara 80 yıllık uzun bir ömür. Bir hatırlatma, bir kehanet değil.",
    s_weeks_axis: "yaş",
    w_lived: "yaşanan",
    w_now: "şu an",
    w_left: "kalan",
    ...
    s_life_caption: "Tabii bu sadece ortalama. Sen daha iyisini yaparsın, biliyoruz.",
    ...
    r_trips: "Güneş turu",
    r_life: "tamamlandı",
    footer: "Zaman, harcadığın ama asla geri kazanamadığın tek para.",
  ...
  en: {
    ...
    cover: {
      ...
      subtitle: "Enter your birth date. Let the numbers do the talking.",
      day: "Day",
      month: "Month",
      year: "Year",
      calculate: "Wrap my life",
      hint: "One date. The rest is a surprise.",
    },
    ...
    s_seconds_caption: "And it's still climbing as you read this. It doesn't stop.",
    ...
    s_heart_caption: "Both still running. Without you ever giving the order.",
    ...
    s_weeks_note: "The grid is a long life of 80 years. A reminder, not a prophecy.",
    s_weeks_axis: "age",
    w_lived: "lived",
    w_now: "now",
    w_left: "ahead",
    ...
    s_life_caption: "That's just the average, of course. You'll beat it. Obviously.",
    s_life_sub: (days, weeks) =>
    ...
    r_trips: "sun trips",
    r_life: "complete",
    footer: "Time is the only currency you spend and can never earn back.",
...
export const mementoLines = {
  tr: [
    ...
    { max: 19, text: "Vakit sonsuz görünüyor. Bu yanılsama da bir armağan." },
    { max: 29, text: "Sandığından hızlı akıyor. Önemli olanı erteleme." },
    { max: 39, text: "Bir ömrün üçte birinden fazlası geçti. Gerisi senin." },
    { max: 49, text: "Yarısına yaklaştın. Diğer yarısı hâlâ önünde." },
    { max: 59, text: "Artık günleri saymıyorsun; onları dolduruyorsun." },
    { max: 69, text: "Çok kış gördün. Her biri seni biraz daha sağlam yaptı." },
  ...
  en: [
    ...
    { max: 29, text: "It moves faster than you think. Stop postponing what matters." },
    { max: 39, text: "More than a third of a life is spent. The rest is yours." },
    { max: 49, text: "Nearing the halfway mark. The other half is still ahead." },
    { max: 59, text: "You no longer count the days; you fill them." },
    { max: 69, text: "You've seen many winters. Each one made you steadier." },
...
export function pickMementoLine(lang, ageYears) {
  ...
  return (lines.find((l) => ageYears <= l.max) || lines[lines.length - 1]).text
}
